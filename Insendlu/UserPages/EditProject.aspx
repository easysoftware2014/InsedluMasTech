<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/UserPages/EditProject.aspx.cs" Inherits="Insendlu.UserPages.EditProject" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <input type="text" runat="server" class="form-control" id="projecName" />
            ...
            <section id="wizard">
                ...
                <div id="rootwizard">
                    <div class="navbar">
                        <div class="navbar-inner">
                            <div class="container">
                                <ul>
                                    <li><a href="#tab0" data-toggle="tab">Project Team</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:TextBox runat="server" CssClass="form-control" ID="projectName"></asp:TextBox>
                        ...
                        <div class="tab-pane" id="tab1">
                            <cc1:Editor ID="execSummary" runat="server" Height="250"></cc1:Editor>
                        </div>
                ...
                <cc1:Editor ID="editor5" runat="server" Height="250" TargetControlID="txtEditor"></cc1:Editor>
                        ...
                        <div class="pull-right">
                            <asp:Button CssClass="btn btn-primary" ID="Update" OnClick="Update_OnClick" Text="Update" runat="server"></asp:Button>
